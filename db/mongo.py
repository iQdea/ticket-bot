...
class Mongo:
    ...
    if len(client.collection_names()) == 0:
        ...
        {"username" : "orgkom","first_name" : "FC","last_name" : "Barcelona","age" : 90,"role" : "organizer", "password" : "63a9f0ea7bb98050796b649e85481845", "creator" : "NULL"}
        ]
        ...
        # {"ticket_id" : 2,"card_id" : 1,"price" : 40.99,"match_id" : 4,"block" : "1","row" : "1","place" : "2"}
        # ]
        # collection_name.insert_many(tickets_list)
